...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="nav-hero">
        ...
        <div class="hero">
            <div class="hero-text">
                <h1>The Cloud Based Point of Sale for Every Kind of Business & Location</h1>
                <p>Complete sales quickly with our point of sale SaaS, seamlessly accepting all forms of    payments. Keep customers coming back with rewards while automatically synchronizing customer and inventory information in the <b>Cloud-based back office</b>.
                </p>
                <div class="hero-link">
